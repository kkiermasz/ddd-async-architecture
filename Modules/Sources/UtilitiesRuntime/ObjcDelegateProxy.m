...
NSArray * _Nonnull unpackInvocation(NSInvocation * _Nonnull invocation) {
    ...
    // https://github.com/ReactiveX/RxSwift/blob/b4307ba0b6425c0ba4178e138799946c3da594f8/RxCocoa/Runtime/_RXObjCRuntime.m#L149
    for (NSUInteger index = 2; index < numberOfArguments; ++index) {
        const char *argumentType = [invocation.methodSignature getArgumentTypeAtIndex:index];

        // Skip const type qualifier.
        // https://github.com/ReactiveX/RxSwift/blob/b4307ba0b6425c0ba4178e138799946c3da594f8/RxCocoa/Runtime/_RXObjCRuntime.m#L154
        if (argumentType[0] == 'r') { argumentType++; }
...
+ (NSSet <NSValue *> *) selectorsOfProtocol: (Protocol * __unsafe_unretained) protocol
    ...
    // Protocol methods
    for (NSInteger index = 0; index < protocolMethodCount; index++) {
...
+ (NSSet <NSValue *> *) selectorsOfProtocolPointer: (Protocol * __unsafe_unretained * _Nullable) pointer
    ...
    for (NSInteger index = 0; index < count; index++) {
        Protocol * __unsafe_unretained _Nullable protocol = pointer[index];
